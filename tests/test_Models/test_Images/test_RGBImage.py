...
def test_get_setImage():
    ...
    imageTest.image = ("/test-results/images/single/cross_section_demo_image.jpeg")
    image1.setImage("/test-results/images/single/cross_section_demo_image.jpeg")
...
def test_save_load_rotateImage():
    ...
    imageActual.setFilePath("test-results/images/single/test_RGBImage_rotate.jpeg")
    imageTest2 = imageActual.loadImage()
    image1.loadImage(imageActual)
    image1.rotateImage()
    image1.saveImage(imageActual,"test-results/results")
    assert image1 
...
def test_toRBG_toBGR():
    ...
    image1 = RGBImage(filePath)
    imageActual = RGBImageFile()
    imageActual.setFilePath("test-results/images/single/test_RGBImage_BGR_Test.jpeg")
    #imageTest2 = imageActual.loadImage()
    image1.loadImage(imageActual)
    image1.toBGR()
    image1.saveImage(imageActual,"test-results/results")
    imageActual.setFilePath("test-results/images/single/test_RGBImage_RGB_Test.jpeg")
    image1.toRGB()
    image1.saveImage(imageActual,"test-results/results")
    assert image1

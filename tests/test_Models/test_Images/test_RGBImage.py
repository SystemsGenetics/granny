...
def test_get_setImage():
    ...
    imageTest.image = ("/demo/cross_section_images/cross_section_tray/cross_section_demo_image.jpeg")
    image1.setImage("/demo/cross_section_images/cross_section_tray/cross_section_demo_image.jpeg")
...
def test_save_load_rotateImage():
    ...
    imageActual.setFilePath("demo/cross_section_images/cross_section_tray/cross_section_demo_image.jpeg")
    imageTest2 = imageActual.loadImage()
    image1.loadImage(imageActual)
    image1.rotateImage()
    image1.saveImage(imageActual,"tmp2/")
    assert image1 
...
def test_toRBG_toBGR():
    ...
    image1.loadImage(imageActual)
    image1.toBGR()
    image1.saveImage(imageActual,"tmp3/")
    image1.toRGB()
    image1.saveImage(imageActual,"tmp4/")
    assert image1

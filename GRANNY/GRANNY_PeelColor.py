...
class GrannyPeelColor(granny.GrannyBase):
    def __init__(self, action: str, fname: str):
        ...
        # self.MEAN_VALUES_A = [
        #    -37.46455193845067, -38.33945889256972, -35.856673734593976, -28.66620337913712, -25.183705217005663,
        #    -22.73535185450301, -20.153556829155015, -18.57975296251061, -15.422998269835011, -14.839191848288477
        # ]
        # self.MEAN_VALUES_B = [

...
```bash
granny -i cli --analysis segmentation --input ./images/ --conf 0.35 --iou 0.6 --row_tolerance 15
```
...
```bash
granny -i cli --analysis blush --input ./pears/ --th 150 --blush_color_r 200 --font_scale 1.5
```
